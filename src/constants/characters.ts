...
const zenitsuAbilities: Ability[] = [
  {
    ...
    description:
      'Blitzschnelle Bewegung mit verheerender Durchschlagskraft',
...
const muzanAbilities: Ability[] = [
  {
    ...
    description:
      'Verwandelt Körperteile in tödliche Klingen und Tentakel',
    breathingStyle: BreathingStyle.DEMON_BLOOD,
  },
  {
...
export const DEMONS: Character[] = [
  {
    ...
    voiceStyle:
      'Kalt, arrogant, bedrohlich. Spricht mit absoluter Autorität',
    strengths: [
      'Nahezu unbesiegbar',
  ...
  },
  {
    ...
    voiceStyle:
      'Hochnäsig, kapriziös. Schreit wenn wütend, weint schnell',
    strengths: [
      'Obi-Kontrolle',
      'Schönheit als Waffe',
      'Verstecken in Obi',
  ...
  },
  {
    ...
    voiceStyle:
      'Kratzig, hasserfüllt, verbittert. Wird sanfter bei Daki',
    strengths: [
      'Tödliches Gift',
      'Kampferfahrung',
  ...
  },
  {
    ...
    voiceStyle:
      'Sanft, fast flüsternd, gruselig höflich. Genießt Qual anderer',
    strengths: [
      'Traummanipulation',
      'Schwer zu bekämpfen',
